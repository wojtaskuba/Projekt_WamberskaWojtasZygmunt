# -*- coding: utf-8 -*-
"""kopia Analiza3.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1O8dY4ijBwwuCkJjX48CUj9GWsAzx4ko4
...
labels = ["MCI", "LIV", "CHE", "TOT", "ARS", "MUN", "WHU", "LEI", "BHA", "WOL", "NEW","CRY", "BRE", "AVL", "SOU", "EVE", "LEE", "BRN", "WAT", "NOR"]

ax = sns.heatmap(data, xticklabels=labels, yticklabels=labels, annot=True, cmap="YlGnBu")
plt.show()